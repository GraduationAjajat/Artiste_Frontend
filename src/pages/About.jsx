    ...
    <AboutContainer>
      <ContentContainer>
        ...
        <Content>
          ...
          <Subtitle>
            아르티스트는 온라인 아트뮤지엄으로 누구나 반고흐가 될 수 있다.
          </Subtitle>
          <Text>
            우리는 우리의 추억을 자신이 원하는 스타일의 화풍으로 출력하여
            자신만의 미술 작품을 만들어낼 수 있도록 한다. 이를 2D와 3D로
            전시하여 사람들과 공유함으로써 온라인으로 누구나 예술가가 될 수 있는
            경험을 제공한다.
          </Text>
        </Content>
      </ContentContainer>
      <ContentContainer>
        <Content>
          ...
          <Subtitle>
            아르티스트는 온라인 아트뮤지엄으로 누구나 예술가를 만날 수 있다.
          </Subtitle>
          <Text>
            우리는 인기 예술가를 만나고 관심있는 전시를 관람할 수 있으며,
