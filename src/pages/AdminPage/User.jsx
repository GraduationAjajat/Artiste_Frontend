...
const User = () => {
  ...
  const clickCommentBtn = (id, userId) => {
    ...
    axios.get(`/api/v1/admin/${userId}`).then((res) => {
            ...
            <ContentContainer>
              ...
              <Content>
                ...
                <RowContainer style={{ gap: "5px" }}>
                  ...
                  <BlackText style={{ marginRight: "15px" }}>
                    {user.registerDate.substring(0, 10)}
                  </BlackText>
                  <BlackText>작성한 글</BlackText>
                  <BlackText style={{ marginRight: "15px" }}>
                    {user.exhibitionCount}
                  </BlackText>
                ...
                <BtnContainer>
                  <div>
                    ...
                    <Btn
                      ...
                      onClick={() => clickCommentBtn(i, user.userId)}
                    ></Btn>
                  </div>
                </BtnContainer>
              )}
                ...
                <>
                  <CommentContainer display={display[i]}>
                    ...
                    <Right>
                      ...
                      <DeleteBtn onClick={() => clickDelete(comment.id)}>
                        삭제
                      </DeleteBtn>
                    </Right>
                  </CommentContainer>
