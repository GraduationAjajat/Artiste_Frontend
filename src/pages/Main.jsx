  ...
  return (
    <MainContainer>
       <CardContainer>
         ...
         <BlackText size={"24px"} style={{margin:"16px 0 36px 0"}}>이곳은 예술가가 될 수 있고 예술가를 만날 수 있는<br/>아르티스트&#40;Artiste&#41;입니다. </BlackText>
         <BlackBtn width={"240px"} height={"60px"}>
         
           <span>전시관람하기</span>
           <img src='../imgs/rightArrow.svg' style={{verticalAlign:"top", marginLeft:"15px"}}></img>
          </BlackBtn>
       </CardContainer>
    </MainContainer>
  )
